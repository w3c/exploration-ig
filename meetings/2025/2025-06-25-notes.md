...
Proposal \#1: [Digital credentials versioning and compatibility for an interoperable web](https://github.com/w3c/exploration-ig/issues/1) 
...
**Mitchell Nguyen**: proposal \#3 [Evolving the web for humans and non-humans (IoTs, NHIs, AI Agents, etc.) with digital credentials](https://github.com/w3c/exploration-ig/issues/3)
